...
public class BillServiceImpl implements BillService {
        ...
        for (Meter meter : meterList) {
            ...
            if (meterDataList.size() > 2) {
                ...
                if ((new Date().getTime() - meterDataCurrent.getCreationDate().getTime()) / (24 * 60 * 60 * 1000) > 30) {
                    ...
                    meterDataCurrent.setAutogenerated(true);
    ...
    @Override
    public List<Bill> getAllByStatus(SendStatus sendStatus) {
        return billRepository.findAllBySendStatus(sendStatus);
    }
